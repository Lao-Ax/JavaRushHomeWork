...
2. Сериализация элементов additionalMap в json должна происходить, как сериализация обычных полей
 класса.
3. Десериализация элементов additionalMap из json должна происходить, как десериализация обычных
полей класса.
...
public class Solution {
    public static void main(String[] args) throws IOException {
        ...
        String sampleJsonString = "{\"id\":1,\"name\":\"first\",\"KEY#1\":\"VALUE#1\"," +
