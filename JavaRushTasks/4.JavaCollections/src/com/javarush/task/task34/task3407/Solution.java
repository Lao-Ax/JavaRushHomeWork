...
Требования:
1. Метод getFilledList должен возвращать список заполненный фантомными ссылками на объекты типа
Monkey.
...
public class Solution {
    ...
    public static class Helper {
        ...
        public void checkListWithReferences(List<PhantomReference<Monkey>> list, String string) {
            ...
            System.out.println(String.format("The enqueue reference count is %d (%s GC was " +
                    "called)", count, string));
        }
