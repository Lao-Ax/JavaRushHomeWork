...
public class Solution {
    public static void main(String[] args) {
        ...
        Properties properties = solution.getProperties("F:\\IntelliJ IDEA work\\JavaRushHomeWork\\JavaRushTasks" +
                "\\4.JavaCollections\\src\\com\\javarush\\task\\task31\\task3109\\properties.txt");
        properties.list(System.out);

        properties = solution.getProperties("F:\\IntelliJ IDEA work\\JavaRushHomeWork\\JavaRushTasks" +
                "\\4.JavaCollections\\src\\com\\javarush\\task\\task31\\task3109\\properties.xml");
        properties.list(System.out);
