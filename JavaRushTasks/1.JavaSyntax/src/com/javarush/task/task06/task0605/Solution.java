...
Программа должна считывать введенные пользователем вес в килограммах и рост в метрах и выводить на экран сообщение о
индексе массы тела.
...
public class Solution {
    ...
    public static class Body {
        public static void massIndex(double weight, double height) {
            ...
            if (Double.compare(index, 18.5d) < 0) {
                System.out.println("Недовес: меньше чем 18.5");
            } else if (Double.compare(index, 24.9d) < 0) {
                System.out.println("Нормальный: между 18.5 и 24.9");
            } else if (Double.compare(index, 29.9d) < 0) {
