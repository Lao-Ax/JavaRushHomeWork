...
/* Заметки
1.part1. Класс Note будет использоваться нитями.
...
2.1.part1. используя метод addNote добавит заметку с именем [getName() + "-Note" + index], например, при index=4
"Thread-0-Note4"
...
public class Solution {
    ...
    public static NoteThread noteTread = new NoteThread();
