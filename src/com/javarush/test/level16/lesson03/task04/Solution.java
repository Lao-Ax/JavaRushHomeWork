...
/* Вывод стек-трейса
1.part1. Создать таск - класс public static SpecialThread - на основании интерфейса Runnable
...
public class Solution {
    ...
    public static class SpecialThread implements java.lang.Runnable {
        @Override
        public void run()
        {
            for (StackTraceElement element : Thread.currentThread().getStackTrace())
