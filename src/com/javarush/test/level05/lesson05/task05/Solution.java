...
public class Solution {
    public static void main(String[] args) {
        ...
        System.out.println(firstLittleCat.fight(secondLittleCat));
        System.out.println(firstLittleCat.fight(thirdLittleCat));
        System.out.println(secondLittleCat.fight(thirdLittleCat));
    }
