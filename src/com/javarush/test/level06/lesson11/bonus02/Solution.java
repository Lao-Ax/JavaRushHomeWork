...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        Cat grandPa = new Cat(reader.readLine(), null, null);
        Cat grandMa = new Cat(reader.readLine(), null, null);
        Cat catFather = new Cat(reader.readLine(), grandPa, null);
        Cat catMother = new Cat(reader.readLine(), null, grandMa);
