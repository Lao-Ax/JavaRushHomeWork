...
1.part1. Создать класс Hen
1.part1.1.part1. Сделать его абстрактным
1.part1.2. Добавить в класс абстрактный метод  int getCountOfEggsPerMonth()
1.part1.3. Добавить в класс метод String getDescription(), который возвращает строку "Я курица."
