...
1.part1. Поведение программы осталось прежним, т.е. она должна выдавать то же самое, что и выдает сейчас
2. Метод containsBones должен возвращать тип Object и значение "Yes" вместо true, "No" вместо false

[Большой не содержит кости, Указательный не содержит кости, Средний не содержит кости, Безымянный содержит кости,
Мизинец не содержит кости]
...
public class Solution {
    ...
    public static class Finger extends BodyPart {
        ...
        public Object containsBones() {
            boolean b = super.containsBones().toString().equals("Yes");
            return (b && !isFoot) ? "Yes" : "No";
        }
    }
    ...
    private static void printlnBodyParts() {
        List<BodyPart> bodyParts = new ArrayList<BodyPart>(4);
